    ...
    public class ShotSpawnSystem: ComponentSystem {
      ...
      protected override void OnUpdate() {
        ...
        for (int i = 0; i < m_Data.Length; ++i) {
          ...
          em.AddComponent(shotEntity, new MoveSpeed{speed = AsteroidsBootstrap.Settings.bulletMoveSpeed});
          em.AddSharedComponent(shotEntity, AsteroidsBootstrap.PlayerShotLook);
        }
      }
    }
}
